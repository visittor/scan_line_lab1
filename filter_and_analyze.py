...
cdef np.ndarray[DTYPE_INT_t,ndim = 3] angle_const_hist_c(np.ndarray[DTYPE_INT_t,ndim = 2] lines, int n_angle_bin, int n_const_bin, int min_angle, int max_angle, int min_const, int max_const):
